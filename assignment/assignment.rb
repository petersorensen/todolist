...
class Assignment
  ...
  def create_todolist(params)
      ...
      listinfo = {list_name: params[:name],list_due_date: params[:due_date]}
      newlist =TodoList.new(listinfo)
      newlist.save
  end
  ...
  def find_alllists(offset, limit)
      ...
      TodoList.offset(offset).limit(limit).all.order(updated_at: :desc).to_a
  end
